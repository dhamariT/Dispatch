...
logger. Use it for all logging in Dispatch. Prefer key-value pairs
...
Use `slog.With` to attach persistent fields like device IDs or deploy
IDs to a logger instance. Pass loggers via context or struct fields.
